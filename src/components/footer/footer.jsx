...
import LOGOICON from '../../assets/img/dbrandmarketing/logo.jpg';
            ...
            <div className='container-fluid'>
                <div className='row'>
                    <div className='col-md-4'>
                        ...
                        <div>Connect with digital marketing experts on social media to grow your brand and business !!</div>
                        ...
                        <div>info@dbrandmarketing.com</div>
                    </div>
